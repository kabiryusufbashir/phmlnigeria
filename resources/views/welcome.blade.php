...
@section('body-content')
    ...
    <div id="banner-img">
        ...
        <div class="absolute lg:top-48 top-52">
            <div class="text-white font-extrabold p-8 rounded-tr-lg slogan-logo" id="slogan">        
                <p class="flex justify-center text-white font-semibold p-5">
                    Introducing the Police HMO Providers' Portal
                </p>
                <p class="lg:text-lg">
                    Code Requests, Claims Processing & Reconciliation has never been easier. <br>
                    Make submissions, get feedback & monitor progress ALL IN REAL TIME. <br>
                    So, what are you waiting for? Sign up and sign in now <br>
                    <div class="mt-4 lg:w-2/6 mx-auto bg-gray-200 text-gray-700 px-2 py-2 rounded hover:text-green-600 hover:border-b-2 hover:border-green-600"><a href="https://erp.phmlnigeria.com/app/hospital/auth/">Let's Go!</a></div>
                </p>
            </div>
        </div>
    </div>
    ...
    <div class="pt-8 pb-5 text-justify">
        ...
        <!-- Slogan  -->
        <div class="lg:px-24 px-8 py-16 lg:w-1/2 mx-auto bg-white border">
            <!-- About Us  -->
            <div class="lg:flex justify-between items-center">
                <p class="py-3 lg:w-3/6 text-2xl lg:text-2xl">
                    We cover treatments outside the NHIS Benefit Package (Tertiary Assistance)
                </p>
                <p>
                    <div class="mt-4 lg:w-1/3 mx-auto bg-green-700 text-white lg:text-xl text-xl text-center px-2 lg:py-3 py-2 rounded hover:text-green-600 hover:border-b-2 hover:border-green-600"><a href="https://erp.phmlnigeria.com/app/hospital/auth/">How to Apply</a></div>    
                </p>
            </div>
        </div>
    </div>
